...
local Window = redzlib:MakeWindow({ Title = "LongHuy Hub : Meme Sea", SubTitle = "by LongHuy", SaveFolder = "LHHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid://109902353427739", BackgroundTransparency = 0 },
